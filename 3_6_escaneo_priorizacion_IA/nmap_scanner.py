...
def priorizar_hosts(network_data):
    ...
    chat_completion = client.chat.completions.create(
        messages=[
            ...
            {"role": "user",
             "content": f"Teniendo en cuenta el siguiente descubrimiento de hosts, servicios y versiones, ordena los hosts de más vulnerable a menos vulnerable y propón los siguientes pasos para la fase de explotación de cada host.\n\n{network_data}"},
        ],
...
if __name__ == "__main__":
    ...
    network_data = services_scan('192.168.1.0/24')
